...
<nav class="navbar navbar-expand-lg bg-body-tertiary">
	<div class="container-fluid">
		<span style="font-size: 25px" >
			<img src="Logo.png" alt="Logo" width="64" height="70" class="d-inline-block align-text-center">
			Cuddles Vet Clinic
		</span>
		<div class:show={isOpen} class="nav justify-content-center" id="navbarNav">
			<ul class="navbar-nav">
				...
				<li class="nav-item">
					<a
						class:active={$page.url.pathname === '/appointment'} class="nav-link" href="/appointment"
						>Appointment</a
					>
				</li>
				<li class="nav-item">
